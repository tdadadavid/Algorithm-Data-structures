...
public class LC977_SquaresOfSortedArray {
    public static void main(String[] args){
        ...
        System.out.println(Arrays.toString(sortedSkuez(testcase)));
        System.out.println(Arrays.toString(sortedSkuez(testcase2)));
        System.out.println(Arrays.toString(sortedSkuez(testcase3)));
        System.out.println(Arrays.toString(sortedSkuez(testcase4)));
        System.out.println(Arrays.toString(sortedSkuez(testcase5)));
    }
    ...
    // Time complexity = O(n)
    // Space complexity = O(n)
    private static int[] sortedSkuez(int[] nums){
