...
class UndergroundSystem {
    ...
    private HashMap<Integer , Double> userIdAndTimeDiff = new HashMap<>();
    private HashMap<String , String>  startStationAndEndStation = new HashMap<>();
    private HashMap<String[] , Integer> numberOfTimesTripWasMade = new HashMap<>();
    private HashMap<String[] , Double> EachTripAndTimeTaken =  new HashMap<>();
    private HashMap<Integer , String> userAndCheckInStation = new HashMap<>();
